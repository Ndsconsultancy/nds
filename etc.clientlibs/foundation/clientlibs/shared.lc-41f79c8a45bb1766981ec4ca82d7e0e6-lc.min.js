window._g = window._g || {};
_g.shared = {};
void 0 === window.console && (window.console = { log: function (b) {} });
_g.shared.HTTP = new (function () {
  var b = function () {
    ...
    c = function (a) {
      if (!a) return null;
      var d = b();
      d.body = a.responseText;
      d.headers[_g.HTTP.HEADER_STATUS] = a.status;
  ...
  return {
      ...
      if (void 0 != d)
        return _g.$.ajax({
          ...
          complete: function (a, e) {
            a = c(a);
            g || _g.HTTP.handleForbidden(a);
            d.call(b || this, this, "success" == e, a);
          },
        });
      try {
        var e = _g.$.ajax({
          ...
          f = c(e);
        g || _g.HTTP.handleForbidden(f);
        return f;
      } catch (k) {
        return null;
      }
    },
    post: function (a, d, b, c, h, f) {
      a = _g.HTTP.externalize(a, !0);
      if ((h = _g.HTTP.getXhrHook(a, "POST", b))) (a = h.url), (b = h.params);
      if (void 0 != d)
        return _g.$.ajax({
          type: "POST",
          url: a,
          ...
          complete: function (a, b) {
            var e = _g.HTTP.buildPostResponseFromHTML(a.responseText);
            f || _g.HTTP.handleForbidden(a);
            d.call(c || this, this, "success" == b, e);
          },
        });
      try {
        var e = _g.$.ajax({
          ...
          g = _g.HTTP.buildPostResponseFromHTML(e.responseText);
        f || _g.HTTP.handleForbidden(e);
        return g;
      } catch (m) {
        return null;
      }
    ...
    getParameter: function (a, d) {
      a = _g.HTTP.getParameters(a, d);
      return null != a ? a[0] : null;
    },
    getParameters: function (a, d) {
      var b = [];
      if (!d) return null;
      ...
      for (var c = 0; c < a.length; c++) {
        var h = a[c].split("\x3d");
        h[0] == d && b.push(1 < h.length ? decodeURIComponent(h[1]) : "");
      }
      return 0 < b.length ? b : null;
    },
    addParameter: function (a, d, b) {
      if (b && b instanceof Array) {
        for (var c = 0; c < b.length; c++) a = _g.HTTP.addParameter(a, d, b[c]);
        return a;
      }
      c = -1 == a.indexOf("?") ? "?" : "\x26";
      var e = a.indexOf("#");
      if (0 > e)
        return a + c + encodeURIComponent(d) + "\x3d" + encodeURIComponent(b);
      var f = a.substring(e);
      a = a.substring(0, e);
      return a + c + encodeURIComponent(d) + "\x3d" + encodeURIComponent(b) + f;
    },
    setParameter: function (a, d, b) {
      a = _g.HTTP.removeParameter(a, d);
      return _g.HTTP.addParameter(a, d, b);
    },
    removeParameter: function (a, d) {
      var b = "?" + encodeURIComponent(d) + "\x3d";
      d = "\x26" + encodeURIComponent(d) + "\x3d";
      if (-1 == a.indexOf(b))
        if (-1 != a.indexOf(d)) b = d;
        else return a;
      d = a.indexOf(b);
      b = a.substring(0, d);
      d = a.indexOf("\x26", d + 1);
      ...
      -1 != d &&
        ((c = a.substring(d)),
        0 == c.indexOf("\x26") && (c = c.replace("\x26", "?")));
      return b + c;
    },
    removeParameters: Granite.HTTP.removeParameters,
    addSelector: function (a, d, b) {
      b || (b = 0);
      var c = "",
        e = a.indexOf("?");
      -1 == e && (e = a.indexOf("#"));
      -1 != e && ((c = a.substring(e)), (a = a.substring(0, e)));
      var f = a.lastIndexOf("/");
      e = a.substring(f);
      if (-1 == e.indexOf("." + d + ".")) {
        a = a.substring(0, f);
        e = e.split(".");
        var k = (f = "");
        if (b > e.length - 2 || -1 == b) b = e.length - 2;
    ...
    setSelector: function (a, b, c) {
      var d = "",
        e = a.indexOf("?");
      -1 == e && (e = a.indexOf("#"));
      -1 != e && ((d = a.substring(e)), (a = a.substring(0, e)));
      e = _g.HTTP.getSelectors(a);
      var f = a.substring(a.lastIndexOf("."));
      a = a.substring(0, a.lastIndexOf("."));
      a = 0 < e.length ? a.replace("." + e.join("."), "") : a;
      if (0 < e.length)
    ...
    addSelectors: function (a, b) {
      var d = a;
      if (a && b && b.length)
        for (a = 0; a < b.length; a++) d = _g.HTTP.addSelector(d, b[a], a);
      return d;
    },
    getAnchor: function (a) {
      return -1 != a.indexOf("#") ? a.substring(a.indexOf("#") + 1) : "";
    },
    ...
    noCaching: function (a) {
      return _g.HTTP.setParameter(
        a,
        _g.HTTP.PARAM_NO_CACHE,
        new Date().valueOf()
      );
    },
    buildPostResponseFromNode: function (a, d) {
      if (!a) return null;
      void 0 == d && (d = b());
      for (var c = 0; c < a.childNodes.length; c++) {
        var g = a.childNodes[c];
        g.tagName &&
          (g.id && (d.headers[g.id] = g.href ? g.href : g.innerHTML),
          (d = _g.HTTP.buildPostResponseFromNode(g, d)));
      }
      return d;
    },
    buildPostResponseFromHTML: function (a) {
      var d = b();
      try {
        ...
        c.innerHTML = a;
        d = _g.HTTP.buildPostResponseFromNode(c, d);
      } catch (g) {}
      return d;
    },
      ...
      if (0 < a.length) {
        ...
        if (-1 != c)
          return (
            ...
            (b = a.indexOf(";", c)),
            -1 == b && (b = a.length),
            decodeURIComponent(a.substring(c, b))
          );
      }
      return null;
    },
    setCookie: function (a, b, c, g, h, f) {
      "number" != typeof g && (g = 7);
      if (0 < g) {
        var d = new Date();
        d.setTime(d.getTime() + 864e5 * g);
      } else d = new Date(0);
      document.cookie =
        ...
        "; " +
        (0 != g ? "expires\x3d" + d.toGMTString() + "; " : "") +
        (h ? "domain\x3d" + h + "; " : "") +
        (c ? "path\x3d" + c : "") +
        (f ? "; secure" : "");
      return b;
    },
    clearCookie: function (a, b, c, g) {
      _g.HTTP.setCookie(a, "null", b || "", -1, c || "", g || "");
    },
    ...
    getSelectors: function (a) {
      if (!a && window.CQURLInfo && CQURLInfo.selectors)
      ...
      if ((a = a.substring(a.lastIndexOf("/"))))
        if (((a = a.split(".")), 2 < a.length))
          for (var c = 0; c < a.length; c++)
            0 < c && c < a.length - 1 && b.push(a[c]);
      return b;
    },
    getExtension: function (a) {
      if (!a && window.CQURLInfo && CQURLInfo.extension)
    ...
    handleForbidden: function (a, b) {
      try {
        return 403 == a[_g.HTTP.HEADER_STATUS.toLowerCase()]
          ? (Granite.HTTP.handleLoginRedirect(), !0)
          : !1;
      } catch (e) {
        return !1;
      }
    ...
    getXhrHookedURL: function (a, b, c) {
      return (b = _g.HTTP.getXhrHook(a, b, c)) ? b.url : a;
    },
    reloadHook: function (a) {
      "undefined" != typeof G_RELOAD_HOOK &&
        _g.$.isFunction(G_RELOAD_HOOK) &&
        ("" != CQURLInfo.selectorString &&
          (a = _g.HTTP.addSelector(a, CQURLInfo.selectorString)),
        (a = G_RELOAD_HOOK(a) || a));
      return a;
    },
  };
...
_g.shared.Util = new (function () {
  return {
    reload: function (b, c, a) {
      b || (b = window);
      c || (c = _g.HTTP.noCaching(b.location.href));
      c = _g.HTTP.reloadHook(c);
      a ? b.location.replace(c) : (b.location.href = c);
    },
    load: function (b, c) {
      _g.Util.reload(window, b, c);
    },
    open: function (b, c, a, d) {
      c || (c = window);
      if (b)
        return (
...
_g.shared.Sling = (function () {
  return {
    ...
    processBinaryData: function (b) {
      if (b && void 0 != b[":jcr:data"]) {
        var c = {};
        c.size = b[":jcr:data"];
    ...
    getContentPath: function (b, c, a) {
      c.lastIndexOf(".") > c.lastIndexOf("/") &&
        (c = c.substr(0, c.indexOf(".", c.lastIndexOf("/"))));
      if (b)
        if (0 == b.indexOf("/")) c = b;
        else {
          if (a)
            for (; 0 == b.indexOf("../"); )
              (b = b.substring(3)), (c = c.substring(0, c.lastIndexOf("/")));
          b = b.replace("./", "");
          c = c + "/" + b;
        }
      return c;
...
_g.shared.XSS = new (function () {
  return {
    getXSSPropertyName: function (b) {
      return b ? (_g.XSS.KEY_REGEXP.test(b) ? b : b + _g.XSS.KEY_SUFFIX) : "";
    },
    getXSSRecordPropertyValue: function (b, c, a) {
      var d = "";
      b &&
        c &&
        ((d = (d = b.get(this.getXSSPropertyName(c)))
          ? d
          : this.getXSSValue(b.get(c))),
        a && !isNaN(a) && (d = _g.Util.ellipsis(d, a, !0)));
      return d;
    },
    getXSSTablePropertyValue: function (b, c, a) {
      var d = "";
      b &&
        c &&
        ((d = (d = b[this.getXSSPropertyName(c)]) ? d : this.getXSSValue(b[c])),
        a && !isNaN(a) && (d = _g.Util.ellipsis(d, a, !0)));
      return d;
    },
    getXSSValue: function (b) {
      return b ? _g.Util.htmlEncode(b) : "";
    },
    updatePropertyName: function (b, c) {
      b &&
        c &&
        b[c] &&
        b.xssProtect &&
        !b.xssKeepPropName &&
        (b[c] = this.getXSSPropertyName(b[c]));
    },
    xssPropertyRenderer: function (b, c, a, d) {
      return d &&
        d.dataIndex &&
        a &&
        a.data &&
        a.data[this.getXSSPropertyName(d.dataIndex)]
        ? ((b = a.data[this.getXSSPropertyName(d.dataIndex)]),
          d.ellipsisLimit &&
            !isNaN(d.ellipsisLimit) &&
            (b = _g.Util.ellipsis(b, d.ellipsisLimit, !0)),
          b)
        : b
        ? b
        : "";
  ...
  return {
    startsWith: function (b, c) {
      return null == b || null == c
        ...
        : c.length > b.length
        ? !1
        : 0 == b.toString().indexOf(c.toString());
    },
    endsWith: function (b, c) {
      if (null == b || null == c) return null == b && null == c;
...
_g.shared.ClientSidePersistence = function (b) {
  var c = {
    PERSISTENCE_NAME: _g.shared.ClientSidePersistence.decoratePersistenceName(
        ...
        for (
          var a = this.getMap(),
            b =
              ...
              "]\n",
            c = 0,
            h = new RegExp("^" + this.config.container + "/"),
            f = 0,
          ...
          var l = k[f];
          if (!this.config.container || "string" != typeof l || l.match(h)) {
            var m = a[l];
            b +=
              "-[" +
              ++c +
    ...
    getKeys: function () {
      ...
      if (a)
        for (var c in a)
          this.config.container
            ? 0 == c.indexOf(this.config.container + "/") &&
              ((a = c.substring(this.config.container.length + 1)), b.push(a))
            : b.push(c);
      return b;
    },
    get: function (a) {
    ...
    set: function (a, b) {
      ...
      if (a.length) {
        var d = [],
          e = this.getMap();
        c.action = e[a] ? "update" : "set";
        b
          ? (e[a] = encodeURIComponent(b))
          : ((c.action = "remove"), delete e[a]);
        for (var k in e) d.push(k + ":\x3d" + e[k]);
        this.cache = e;
        this.write(d.join("|"));
        _g.$.extend(c, {
          value: b,
        ...
        _g.$(_g.shared.ClientSidePersistence).trigger(
          _g.shared.ClientSidePersistence.EVENT_NAME,
          c
        );
      }
    },
  ...
  _g.$.extend(c.config, _g.shared.ClientSidePersistence.getDefaultConfig(), b);
  !1 === c.config.useContainer && (c.config.container = null);
  var a = "test-" + Math.random();
  if (c.config.mode === _g.shared.ClientSidePersistence.MODE_SESSION) {
    b = !1;
    try {
      window.sessionStorage.setItem(a, a), window.sessionStorage.removeItem(a);
    } catch (d) {
      b = !0;
    }
    b && (c.config.mode = _g.shared.ClientSidePersistence.MODE_LOCAL);
  }
  if (c.config.mode === _g.shared.ClientSidePersistence.MODE_LOCAL) {
    b = !1;
    try {
      window.localStorage.setItem(a, a), window.localStorage.removeItem(a);
    } catch (d$0) {
      b = !0;
    }
    b && (c.config.mode = _g.shared.ClientSidePersistence.MODE_WINDOW);
  }
  return c;
};
...
_g.shared.ClientSidePersistence.MODE_SESSION = {
  name: "session",
  read: function (b) {
    return b.getWindow().sessionStorage.getItem(b.PERSISTENCE_NAME);
  },
  write: function (b, c) {
    if (!Granite.OptOutUtil.isOptedOut())
      try {
        b.getWindow().sessionStorage.setItem(b.PERSISTENCE_NAME, c);
      } catch (a) {}
  },
};
_g.shared.ClientSidePersistence.MODE_LOCAL = {
  name: "local",
  read: function (b) {
    return b.getWindow().localStorage.getItem(b.PERSISTENCE_NAME);
  },
  write: function (b, c) {
    if (!Granite.OptOutUtil.isOptedOut())
      try {
        b.getWindow().localStorage.setItem(b.PERSISTENCE_NAME, c);
      } catch (a) {}
  },
};
_g.shared.ClientSidePersistence.decoratePersistenceName = function (b) {
  return b;
};
_g.shared.ClientSidePersistence.MODE_WINDOW = {
  name: "window",
  read: function (b) {
    return b.getWindow().name;
  },
  write: function (b, c) {
    Granite.OptOutUtil.isOptedOut() || (b.getWindow().name = c);
  },
};
_g.shared.ClientSidePersistence.MODE_COOKIE = {
  COOKIE_NAME:
    _g.shared.ClientSidePersistence.decoratePersistenceName(
      "SessionPersistence"
    ),
  name: "cookie",
  read: function (b) {
  ...
  write: function (b, c) {
    if (
      !Granite.OptOutUtil.isOptedOut() ||
      Granite.OptOutUtil.maySetCookie(this.COOKIE_NAME)
    )
      c
        ? _g.shared.ClientSidePersistence.CookieHelper.set(
            this.COOKIE_NAME,
            c,
            365
          )
...
_g.shared.ClientSidePersistence.CookieHelper = {
  set: function (b, c, a) {
    ...
    document.cookie = b + "\x3d" + c + d + "; path\x3d/";
  },
  read: function (b) {
    b += "\x3d";
    for (var c = document.cookie.split(";"), a = 0; a < c.length; a++) {
      for (var d = c[a]; " " == d.charAt(0); ) d = d.substring(1, d.length);
      if (0 == d.indexOf(b))
        return (b = d.substring(b.length, d.length))
  ...
  erase: function (b) {
    _g.shared.ClientSidePersistence.CookieHelper.set(b, "", -1);
  },
};
_g.shared.ClientSidePersistence.clearAllMaps = function () {
  _g.$.each(
    ...
    function (b, c) {
      new _g.shared.ClientSidePersistence({ mode: c }).clearMap();
    }
  );
};
_g.I18n.init();
...
G_RELOAD_HOOK =
  typeof CQ_RELOAD_HOOK != "undefined" ? CQ_RELOAD_HOOK : undefined;
G_IS_HOOKED = typeof CQ_IS_HOOKED != "undefined" ? CQ_IS_HOOKED : undefined;
G_CONTENT_PATH =
  typeof CQ_CONTENT_PATH != "undefined" ? CQ_CONTENT_PATH : undefined;
CQ.shared.Form = (function () {
  var getDocumentLabelMap = function () {
    var contentFrame = parent.frames["ContentFrame"],
      doc =
        contentFrame !== undefined ? contentFrame.contentDocument : document;
    var labelMap = new Object();
    var labelNodes = doc.getElementsByTagName("label");
    for (var i = 0; i < labelNodes.length; i++) {
      var forId = labelNodes[i].htmlFor;
      if (forId) labelMap[forId] = labelNodes[i];
    }
    return labelMap;
  };
  ...
  var getLabelForId = function (id, documentLabelMap) {
    if (!documentLabelMap) documentLabelMap = getDocumentLabelMap();
  ...
  var getDefaultValue = function (node) {
    ...
    var nodeType = hasAttribute(node, "type")
    ...
    if (nodeName == "input")
      ...
      } else if (node.type == "text") defaultValue = node.defaultValue;
      else defaultValue = node.value;
    else if (nodeName == "textarea") defaultValue = node.value;
    ...
    getFields: function () {
      ...
      var visitNamedNode = function (node, inLocalNode, selector) {
        ...
        if (nodeType == "input" || nodeType == "textarea") {
          var controlType = hasAttribute(node, "type")
          ...
          if (
            controlType == "radio" ||
            (field.local && controlType == "checkbox")
          ) {
      ...
      var walkTree = function (node, inLocalNode, selector) {
        if (
          ...
          $CQ(node).children(".form_row").length > 0
        ) {
          inLocalNode = true;
        ...
        for (var i = 0; node.childNodes && i < node.childNodes.length; i++) {
          ...
          if (child.nodeType == 1) walkTree(child, inLocalNode, selector);
        }
      };
...
CQ.shared.User = (function (infoData) {
  return {
    ...
    getUserPropsUrl: function () {
      if (!this.userPropsPath) this.userPropsPath = CQ.shared.User.PROXY_URI;
    ...
    init: function (infoData, force) {
      if (!this.initialized || force) {
        if (infoData) this.data = infoData;
        else this.load();
    ...
    getLanguage: function () {
      if (!this.isInitialized() && this.lazyLoad) this.lazyLoad.call(this);
      this.language =
        this.data &&
...
CQ.shared.User.PROXY_URI = CQ.shared.HTTP.externalize(
  "/libs/cq/security/userinfo" + CQ.shared.HTTP.EXTENSION_JSON
);
